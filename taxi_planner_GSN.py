...
# q_values_gs_paths = os.listdir('.\\q_values\\gsn')
df = pd.DataFrame({
    'learning_rate': [],
    'epsilon_decay': [],
    'discount_factor': [],
...
q_values_gs_path = r'.\q_values\gsn\lr0.1_ed0.0002_df0.99_q_values_gs.pkl'
...
agent = TaxiAgent(
    ...
    final_epsilon=0,
    discount_factor=0,
    q_values_gs_path=q_values_gs_path
)
...
# save results
with open('eval_results\\eval_results_gsn_1000_eps.pkl', 'wb') as f:
    df.to_pickle(f)
